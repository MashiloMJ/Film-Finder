...
Check out these instructions(https://developers.themoviedb.org/3/getting-started/introduction) if you need further assistance with registering for an API key.
...
Replace in script.js: const tmdbKey = 'YOUR_API_KEY';
